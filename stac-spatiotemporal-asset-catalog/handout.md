...
-	Als Entwickler haben Sie zwei Möglichkeiten, STAC zu implementieren: 
  * als **statischen STAC**  (einfach zu erstellen und kann leicht von verschiedenen Tools aufgenommen werden, die die STAC-API generieren) 
  *oder*
  * über die **STAC-API** (ermöglicht die Abfrage von Daten in einer Standardsprache und die Rückgabe einer Teilmenge des Katalogs)
